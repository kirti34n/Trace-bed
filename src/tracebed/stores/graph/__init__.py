...
`upsert_link` completes the normal write side.  Destructive graph cleanup is
not a hot-path capability: E3's separate erasure port owns project-wide
delete-and-zero-proof work.
